...
const RAW_DATA = [
  ...
  { b: "Utility Branch II", c: 10, t: "PE", desc: "Una volta per round, per un singolo attacco, quando tiri per i danni puoi ripetere fino a 3 dadi di tua scelta. Devi utilizzare i nuovi risultati.", br: "Reroll 3 Dadi Danni", cat: "UTILITY", tier: 3, icon: "RotateCw" },
  { b: "Utility Branch III", c: 20, t: "PE", desc: "Una volta per round, per un singolo attacco, quando tiri per i danni puoi ripetere qualsiasi numero di dadi del danno. Devi utilizzare i nuovi risultati.", br: "Reroll Danni Totali", cat: "UTILITY", tier: 4, icon: "RotateCw" },
